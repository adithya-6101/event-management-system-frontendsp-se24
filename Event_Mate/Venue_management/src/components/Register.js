...
//                         Invite Friend
//                         <Link to="/friend_info" className="inviteFriendMessage" onClick={gotoFriendPage}>
//                             Click here
//                         </Link>
//                     </div> */}
...
//                         <button className="inviteFriendButton" onClick={gotoFriendPage}>Invite Friend</button>
//                     </div>
  ...
  return (
    <div className="signupBody">
      <div className="signupContainer">
        ...
        {showSuccessMessage &&(<div className="inviteFriendMessageContainer">
